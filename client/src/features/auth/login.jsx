...
import LogoIcon from "../../assets/logo_design.png";
import "./style.scss";
...
const Login = () => {
  ...
  useEffect(() => {
    document.title = "Why Main Street - Login";
  ...
  return (
    <section className="auth">
      <div className="top-left">
        <img src={LogoIcon} alt="Why Main Street Logo" className="logo-size" />
      </div>
      <div className="content">
        ...
        <p>Login and enjoy with our social media.</p>
